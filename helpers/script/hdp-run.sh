...
hdp encode -a -c helpers/target/tx_cached_input.json -o helpers/target/tx_cached_output.json -p helpers/target/tx_hdp_pie.zip slr none.50 -t 5605816 tx.max_priority_fee_per_gas 12 53 1 0,0,1,1